...
import { chatRoomEnabled, siteMessageEnabled } from '@/config/featureSwitch'
...
export const headerBarConfig: HeaderBarFeatureConfig = {
  ...
  notification: {
    enabled: siteMessageEnabled,
    description: '通知中心（站内信），显示系统通知和消息；由 VITE_ENABLE_SITE_MESSAGE 控制'
  },
  chat: {
    enabled: chatRoomEnabled,
    description: 'IM 聊天室；由 VITE_ENABLE_CHAT_ROOM 控制'
  },
  language: {
    enabled: true,
    description: '多语言切换功能'
